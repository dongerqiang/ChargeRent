package com.qdigo.chargerent.scan.decoding;
...
import com.qdigo.chargerent.activity.ScanBikeActivity;
import com.qdigo.chargerent.scan.camera.CameraManager;
import com.qdigo.chargerent.scan.view.ViewfinderResultPointCallback;
...
public class CaptureFragmentHandler extends Handler {
    ...
    private final ScanBikeActivity fragment;
    ...
    public CaptureFragmentHandler(ScanBikeActivity fragment, Vector<BarcodeFormat> decodeFormats,
                                  String characterSet) {
